...
def test_classifier(env: Q_Environment, pos: tuple[int, int, int]):
    vals = env.get_current_pH_values((94, 70, 68), Direction.South)
    classified = env._classify_pH(vals[0])
    print(classified)

if __name__ == "__main__":
    env = Q_Environment(Path(r"C:\Users\yllip\Documents\in5490\AUV_project\sim\SMART-AUVs_OF-June-1c-0002.nc"))
